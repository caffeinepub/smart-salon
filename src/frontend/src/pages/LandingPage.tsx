...
const PLAY_STORE_URL =
  "https://play.google.com/store/apps/details?id=com.smartsalonaura.app&pcampaignid=web_share";

export default function LandingPage() {
  const currentYear = new Date().getFullYear();
  const appIdentifier = encodeURIComponent(
    typeof window !== "undefined" ? window.location.hostname : "smart-salon",
  );
          ...
          <div className="max-w-5xl mx-auto">
            ...
            <div className="space-y-8 text-center">
              ...
              <p className="text-lg md:text-xl lg:text-2xl text-muted-foreground max-w-3xl mx-auto leading-relaxed text-balance">
                Seamless booking and powerful management tools for customers and
                salon owners
              </p>
        ...
        <div className="container mx-auto px-6 max-w-7xl">
          <div className="text-center max-w-4xl mx-auto space-y-6">
            ...
            <p className="text-lg md:text-xl text-muted-foreground leading-relaxed">
              Smart Salon is a modern salon booking and management app designed
              for customers and salon owners. It allows users to book
              appointments, manage services, and streamline salon operations
              efficiently.
            </p>
          </div>
        </div>
        ...
        <div className="container mx-auto px-6 max-w-7xl">
          <div className="text-center max-w-4xl mx-auto space-y-6">
            ...
            <p className="text-lg md:text-xl text-muted-foreground leading-relaxed text-balance">
              Smart Salon connects customers with salons through instant booking
              and service discovery. Salon owners get powerful tools to manage
              appointments, schedules, and operations efficiently.
            </p>
          </div>
        </div>
      </section>
        ...
        <div className="container mx-auto px-6 max-w-7xl">
          <div className="max-w-4xl mx-auto text-center space-y-8">
            ...
            <p className="text-lg md:text-xl lg:text-2xl text-muted-foreground leading-relaxed text-balance max-w-3xl mx-auto">
              Join thousands of satisfied customers and salon owners using Smart
              Salon
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center pt-6">
              <Button
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-12 lg:gap-16 mb-12">
            ...
            <div className="space-y-5">
              ...
              <p className="text-sm text-muted-foreground leading-relaxed max-w-xs">
                Premium salon booking and management platform for modern
                businesses
              </p>
            </div>
