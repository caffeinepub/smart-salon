    ...
    <div className="space-y-8 py-4 text-foreground">
      <div className="space-y-4">
        ...
        <p className="text-muted-foreground leading-relaxed">
          ...
          you use our salon booking and management platform.
        </p>
      </div>
        ...
        <div className="space-y-3 text-muted-foreground leading-relaxed">
          ...
          <ul className="list-disc list-inside space-y-2 ml-4">
            <li>
              ...
              Name, email address, phone number, and profile details when you
              create an account
            </li>
            <li>
              <strong className="text-foreground">Booking Information:</strong>{" "}
              Appointment details, service preferences, and booking history
            </li>
            <li>
              <strong className="text-foreground">Payment Information:</strong>{" "}
              Payment card details and transaction history (processed securely
              through third-party payment processors)
            </li>
            <li>
              <strong className="text-foreground">Communications:</strong>{" "}
              Messages, reviews, and feedback you provide through our platform
            </li>
            <li>
              <strong className="text-foreground">Usage Data:</strong>{" "}
              Information about how you interact with our platform, including
              device information, IP address, and browsing activity
            </li>
          </ul>
        </div>
      </section>
      ...
      <section className="space-y-4">
        ...
        <div className="space-y-3 text-muted-foreground leading-relaxed">
          ...
          <ul className="list-disc list-inside space-y-2 ml-4">
            <li>
              Facilitate appointment bookings and manage your reservations
            </li>
      ...
      <section className="space-y-4">
        ...
        <div className="space-y-3 text-muted-foreground leading-relaxed">
          ...
          <ul className="list-disc list-inside space-y-2 ml-4">
            <li>
              <strong className="text-foreground">Salon Partners:</strong> We
              share necessary booking and contact information with salons to
              fulfill your appointments
            </li>
            <li>
              <strong className="text-foreground">Service Providers:</strong>{" "}
              Third-party vendors who assist with payment processing, analytics,
      ...
      <section className="space-y-4">
        ...
        <p className="text-muted-foreground leading-relaxed">
          ...
          material changes by posting the updated policy on our platform and
